	...
	return (
		<div className="z-10">
			<textarea
				...
				className={`h-[42px] w-full rounded-none transition-all duration-200 ${isFocused ? "h-56" : ""} mb-3 resize-none border bg-transparent px-3 py-2 outline-none focus:ring-2 focus:ring-gray-500 dark:border-gray-400 dark:text-white dark:focus:ring-white sm:mb-5`}
